...
public class ClimberSubsystem extends SubsystemBase {
  //motor 1
  public final TelemetryTalonFX climbMotor1 = new TelemetryTalonFX(
    ClimberConstants.CLIMB_MOTOR_1_ID, 
    "climber/motor/1", 
    MiscConstants.TUNING_MODE);
  private final Alert climbMotor1Alert = new Alert(
    "climb motor(1) had a fault", AlertType.ERROR);
...
//motor 2
      public final TelemetryTalonFX climbMotor2 = new TelemetryTalonFX(
    ClimberConstants.CLIMB_MOTOR_2_ID, 
    "climber/motor/2", 
    MiscConstants.TUNING_MODE);
  private final Alert climbMotor2Alert = new Alert(
    "climb motor(2) had a fault", AlertType.ERROR);
    private final EventTelemetryEntry climbMotor2Entry =
      new EventTelemetryEntry("/climber/motor2/events");

  private final TunableTelemetryPIDController climbPID = new TunableTelemetryPIDController(
    "pid/climb", 
    ClimberConstants.CLIMB_PID_GAINS);
