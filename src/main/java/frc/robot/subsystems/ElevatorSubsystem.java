...
public class ElevatorSubsystem extends SubsystemBase {
    ...
    private void configMotors() {
        ...
        leftElevatorMotor.setLoggingPositionConversionFactor(Constants.ElevatorConstants.METERS_PER_REVOLUTION);
        leftElevatorMotor.setLoggingVelocityConversionFactor(Constants.ElevatorConstants.METERS_PER_REVOLUTION);

        leftElevatorMotor.setControl(new Follower(Constants.ElevatorConstants.RIGHT_ID, Constants.ElevatorConstants.LEFT_INVERTED));
        // Clear reset as this is on startup
