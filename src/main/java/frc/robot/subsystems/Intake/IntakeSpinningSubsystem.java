...
public class IntakeSpinningSubsystem extends SubsystemBase {
  ...
  public final TelemetryTalonFX intakeSpinningMotor = new TelemetryTalonFX(
    IntakeConstants.SPINNING_MOTOR_ID, 
    "intake/spinning", 
    MiscConstants.TUNING_MODE);
  SlewRateLimiter rateLimiter = new SlewRateLimiter(IntakeConstants.RATE_LIMIT);
  public final TunableTelemetryPIDController spinningPid = new TunableTelemetryPIDController(
    "pid/intake/spin", IntakeConstants.SPINNING_PID_GAINS);
  private SimpleMotorFeedforward spinningff = 
  ...
  private RelativeEncoder intakeSpinningEncoder;
      private EventTelemetryEntry intakeSpinningEvent = new EventTelemetryEntry("intakeSpinningMotor/Event");
    
      private final SysIdRoutine intakeSpinningSysId = new SysIdRoutine(
    ...
    public IntakeSpinningSubsystem() {
      ...
      .ignoringDisable(true).withName("Default Spinning Intake"));
    }
    private void configMotor() {
      ...
      intakeSpinningMotor.setLoggingPositionConversionFactor(Constants.IntakeConstants.GEAR_RATIO_SPINNING);
      intakeSpinningMotor.setLoggingVelocityConversionFactor(Constants.IntakeConstants.GEAR_RATIO_SPINNING);
    ...
    public Command setVoltageCommand(double voltage){
      return this.run(
        ()-> setVoltage(voltage)).withName("intake/spinning/voltage");
    }
